...
public final class BukkitEvents {
	 ...
	 */
	public static boolean callBucketFillEvent(EntityPlayerMP player, @Nullable net.minecraft.item.ItemStack stack, int blockX, int blockY, int blockZ) {
	 ...
	 * @return true если событие не было отменено
	 */
	public static boolean callBucketEmptyEvent(EntityPlayerMP player, @Nullable net.minecraft.item.ItemStack stack, int clickX, int clickY, int clickZ, BlockFace face) {
	 ...
	 * @return true если событие не было отменено
	 */
	public static boolean callBucketEmptyEvent(EntityPlayerMP player, @Nullable net.minecraft.item.ItemStack stack, RayTraceResult target) {
		...
		return callBucketEmptyEvent(player, stack, pos.getX(), pos.getY(), pos.getZ(), Vanilla2Bukkit.getBlockFace(target.sideHit));
	}
	 ...
	 */
	public static boolean callBlockBreakEvent(EntityPlayerMP player, int x, int y, int z) {
		if (player == null) throw new IllegalArgumentException("player is null");
	 ...
	 * @return Результат: выполнен успешно (разрешить) или отменён (запретить)
	 */
	public static boolean callBlockPlaceEvent(EntityPlayerMP player, int x, int y, int z, net.minecraft.block.Block blockPlaced, int metadata, BlockFace face, EnumHand hand) {
		if (player == null) throw new IllegalArgumentException("player is null");
		if (blockPlaced == null) throw new IllegalArgumentException("blockPlaced is null");

		Player bukkitPlayer = Vanilla2Bukkit.getPlayer(player);
		Block bukkitBlock = Vanilla2Bukkit.getBlock(player.getEntityWorld(), x, y, z);
		FakeBlockImpl placed = new FakeBlockImpl(bukkitBlock, Vanilla2Bukkit.getMaterial(blockPlaced), (byte)metadata);
	 ...
	 * @return Результат: выполнен успешно (разрешить) или отменён (запретить)
	 */
	public static boolean callPlayerInteractEvent(EntityPlayerMP player, int x, int y, int z, Action action, BlockFace blockFace, @Nullable net.minecraft.item.ItemStack stack) {
		if (player == null) throw new IllegalArgumentException("player is null");
	...
	public static boolean callEntityChangeBlockEvent(Entity entity, int x, int y, int z, @Nullable BlockStateData newBlock) {
		...
		EntityChangeBlockEvent event = new EntityChangeBlockEvent(
			...
			Vanilla2Bukkit.getBlock(entity.world, x, y, z),
