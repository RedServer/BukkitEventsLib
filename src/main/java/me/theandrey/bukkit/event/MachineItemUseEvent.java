...
public class MachineItemUseEvent extends ItemUseEvent {
	 ...
	 */
	public MachineItemUseEvent(Block machine, IMachineType machineType, @Nullable UUID owner, @Nullable ItemStack item, ClickType click, BlockFace blockFace, @Nullable Block targetBlock, @Nullable Entity targetEntity) {
